                        ...
                        <table class="table table-sm table-hover">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    $all_categories = $news->getAllNews();
                                    ...
                                    if($all_categories){
                                        foreach($all_categories as $key => $cat_data){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="news-form.php?id=<?php echo $cat_data->id;?>" class="btn btn-sm btn-success" style="border-radius: 50%">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <?php 
                                                        $_token = substr(md5("del-cat-".$cat_data->id."-".$_SESSION['token']), 3, 15);
                                                    ?>
                                                    <a href="process/news.php?id=<?php echo $cat_data->id?>&amp;token=<?php echo $_token;?>" onclick="return confirm('Are you sure you want to delete this News?')" class="btn btn-sm btn-danger" style="border-radius: 50%">
                                        ...
                                        ?>
                                        <tr>
                                            <td colspan="5">No news found in the database.</td>
                                        </tr>
                                        <?php
                                    }
                                ?>
